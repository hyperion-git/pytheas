...
From Eq.~\eqref{eq:spring}, the measured acceleration as a function
of orientation is
\begin{equation}
g(\theta,\varphi)
  = g_0\cos\theta
...
\label{eq:sweep}
\end{equation}
where $g_0 \equiv GM_E/r_\oplus^2 - \omega^2 r_\perp$ is the
static effective gravity, and $a_E'$, $a_N'$, $a_U'$ are the
East, North, and Up components of the tidal acceleration.
